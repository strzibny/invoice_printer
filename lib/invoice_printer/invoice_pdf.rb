...
module InvoicePrinter
  class InvoicePDF
    ...
    def build_header
      @pdf.text "Faktura", :size => 20#, :style => :bold
    ...
    def build_purchaser_box
      ...
      unless @invoice.customer_city_part.nil?
        move_down += 15
      end

      unless @invoice.customer_extra_customer_line.nil?
        move_down += 15
      end
      ...
      #@pdf.fill_color "000000"
      if @invoice.customer_ic.nil? and @invoice.customer_dic.nil?
      elsif not @invoice.customer_dic.nil?
        @pdf.text_box "#{labels[:dic]}    #{@invoice.customer_dic}", :size => 10, :at => [290, 565-move_down], :width => 240
      elsif not @invoice.customer_ic.nil?
    ...
    def build_payment_method_box
      ...
      unless @invoice.bank_account_number.nil?
        ...
        if @invoice.account_swift.nil? or @invoice.account_swift.nil?
