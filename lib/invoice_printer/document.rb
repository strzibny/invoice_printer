    ...
    class << self
      def from_json(json)
        new(
          ...
          provider_tax_id:              String(json['provider_tax_id']),
          provider_tax_id2:             String(json['provider_tax_id2']),
          provider_street:              String(json['provider_street']),
          provider_street_number:       String(json['provider_street_number']),
          provider_postcode:            String(json['provider_postcode']),
          provider_city:                String(json['provider_city']),
          provider_city_part:           String(json['provider_city_part']),
          provider_extra_address_line:  String(json['provider_extra_address_line']),
          purchaser_name:               String(json['purchaser_name']),
          purchaser_tax_id:             String(json['purchaser_tax_id']),
          purchaser_tax_id2:            String(json['purchaser_tax_id2']),
          purchaser_street:             String(json['purchaser_street']),
          purchaser_street_number:      String(json['purchaser_street_number']),
          purchaser_postcode:           String(json['purchaser_postcode']),
          purchaser_city:               String(json['purchaser_city']),
          purchaser_city_part:          String(json['purchaser_city_part']),
          purchaser_extra_address_line: String(json['purchaser_extra_address_line']),
          ...
          account_iban:                 String(json['account_iban']),
          account_swift:                String(json['account_swift']),
